...
<form class="m-3" method="post" enctype="multipart/form-data">
        ...
        <tbody>
            <tr>
                <td class="p-3 fs-6">
                    ...
                    <input type="text" name="skill_name" class="popup" value="<?php echo $skill->skill_name; ?>" required>
                    <p class="mb-1 mt-4" style="font-size:14px;">Status</p>
                    <select class="popup pt-0 pb-0" name="status">
                        <option value="<?php echo $skill->status; ?>"><?php echo $skill->status; ?></option>
                        <?php
                        if ($skill->status == '1') {
    ...
    <div class="d-flex align-content-end justify-content-end">
        ...
        <button class="col-example mt-4 mb-4" name="edit_skill" type="submit" style="font-size:calc(13px + 0.1vw);">
            save
        </button>
    </div>
</form>
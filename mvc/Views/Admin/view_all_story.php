                        ...
                        ?>
                            <tr>
                                ...
                                <td class="p-3 pe-0 p-0" style="font-size:20px;">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content p-2">
                                                ...
                                                <div class="modal-footer mt-3 justify-content-center" style="border-top:0 ;">
                                                    ...
                                                    <a href='story?source=delete_story&delete=<?php $id = $story->story_id;
                                                                                                $salt = "SECRET_STUFF";
                                                                                                $encrypted_id = base64_encode($id . $salt);
                                    ...
                                    <a href='#' data-bs-toggle='modal' data-bs-target='#popup<?php echo $id = $story->story_id; ?>'><i class='fa fa-trash-o text-dark' aria-hidden='true'></i></a>
                                </td>
                            </tr>
                        <?php
                        }

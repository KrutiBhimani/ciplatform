                    ...
                    ?>
                        <tr>
                            ...
                            <td class="p-3 pe-0 p-0" style="font-size:20px;">
                                ...
                                <a onClick="javascript:return confirm('Are you sure to delete?');" href='theme?source=delete_theme&delete=<?php $id = $theme->mission_theme_id; $salt = "SECRET_STUFF"; $encrypted_id = base64_encode($id . $salt); echo $encrypted_id; ?>'><i class="fa fa-trash-o text-dark" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    <?php
                    }

                        ...
                        <tr>
                            ...
                            <td class="p-3 pe-0 p-0" style="font-size:20px;">
                                <a href="user?source=edit_user&edit=<?php
                                    ...
                                    <a onClick="javascript:return confirm('Are you sure to delete?');" href='user?source=delete_user&delete=<?php $id = $user->user_id; $salt = "SECRET_STUFF"; $encrypted_id = base64_encode($id . $salt); echo $encrypted_id; ?>'><i class="fa fa-trash-o text-dark" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    <?php
                    }

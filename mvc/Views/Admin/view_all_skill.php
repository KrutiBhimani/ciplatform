                        ...
                        ?>
                            <tr>
                                ...
                                <td class="p-3 pe-0 p-0" style="font-size:20px;">
                                    ...
                                    <a onClick="javascript:return confirm('Are you sure to delete?');" href='skill?source=delete_skill&delete=<?php $id = $skill->skill_id;
                                                                                                                                                $salt = "SECRET_STUFF";
                                                                                                                                                $encrypted_id = base64_encode($id . $salt);
                ...
                <?php if (!isset($_POST['search'])) { ?>
                    <nav aria-label="Page navigation example">
                        <ul class="pagination pager justify-content-end">
                            ...
                            $next = $page + 1;
                            $previous = $page - 1;
                            echo "<li class='page-item'><a class='page-link' href='skill?page=1' style='border-radius:5px; padding:10px; height:30px; width:30px; margin:4px;'><img src='../Assets/previous.png' alt=''></a></li>";
                            if ($previous >= 1)
                                echo "<li class='page-item'><a class='page-link' href='skill?page=$previous' style='border-radius:5px; padding:10px; height:30px; width:30px; margin:4px;'><img src='../Assets/left.png' alt=''></a></li>";
                            else
                                echo "<li class='page-item'><a class='page-link' href='skill?page=1' style='border-radius:5px; padding:10px; height:30px; width:30px; margin:4px;'><img src='../Assets/left.png' alt=''></a></li>";
                            for ($i = 1; $i <= $cnt; $i++) {
                                if ($i == $page)
                            ...
                            if ($next <= $cnt)
                                echo "<li class='page-item'><a class='page-link' href='skill?page=$next' style='border-radius:5px; padding:10px; height:30px; width:30px; margin:4px;'><img src='../Assets/arrow.png' alt=''></a></li>";
                            else
                                echo "<li class='page-item'><a class='page-link' href='skill?page=$cnt' style='border-radius:5px; padding:10px; height:30px; width:30px; margin:4px;'><img src='../Assets/arrow.png' alt=''></a></li>";
                            echo "<li class='page-item'><a class='page-link' href='skill?page=$cnt' style='border-radius:5px; padding:10px; height:30px; width:30px; margin:4px;'><img src='../Assets/next.png' alt=''></a></li>";
                            ?>
                        </ul>
                    </nav>
                <?php } ?>

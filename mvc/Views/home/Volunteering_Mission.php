                        ...
                        <div class="card box border-0">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="color:black">
                                    <div class="card-body pb-3 remove">
                                        <a href="Volunteering_Mission?id=<?php echo $missi->mission_id ?>" style="color:black;">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <button class=" col-example mt-3" style="font-size:calc(13px + 0.1vw);">
                                    ...
                                    if ($key == 1 || $c == 0) { ?>
                                        <a href="Volunteering_Mission?id=<?php echo $missi->missionid ?>" style="color: inherit;">View Detail</a>
                                    <?php } else { ?>
                                        <a href="Volunteering_Mission?id=<?php echo $missi->missionid ?>" style="color: inherit;">Apply</a>
                                    <?php }
                                    ?>

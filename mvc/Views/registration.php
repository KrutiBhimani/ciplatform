        ...
        <div class="Layer-52">
          ...
          <form name="myForm" onsubmit="return validateForm()" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
              ...
              <input type="number" placeholder="Enter your phone number..." name="phone_number" class="Rounded-Rectangle-2 form-control" style="font-size:14px; height:37px;">
              <span id="errorpn" style="color:#f88634"></span>
            </div>
            <div class="form-group mb-3">
              <span class="Email">Email Address</span>
              <input type="email" placeholder="Enter your email address..." name="email" class="Rounded-Rectangle-2 form-control" style="font-size:14px; height:37px;">
              <span id="errorea" style="color:#f88634"></span>
            </div>
            <div class="form-group mb-3">
              <span class="Email">Password</span>
              <input type="password" placeholder="Enter your password..." name="password" class="Rounded-Rectangle-2 form-control" style="font-size:14px; height:37px;">
              <span id="errorp1" style="color:#f88634"></span>
            </div>
            <div class="form-group mb-3">
              <span class="Email">Confirm Password</span>
              <input type="password" placeholder="Enter your password again..." name="password2" class="Rounded-Rectangle-2 form-control" style="font-size:14px; height:37px;">
              <span id="errorp2" style="color:#f88634"></span>
            </div>

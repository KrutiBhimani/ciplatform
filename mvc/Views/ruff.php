            ...
            <div class="d-flex justify-content-between position-relative">
                ...
                <nav class="navbar d-none d-sm-block navbar-expand" style="background-color:white ;">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                        <ul class="navbar-nav me-auto mb-lg-0">
                            <li class="nav-item me-3 hello">
                                <a id="showpopup" class="nav-link dropdown-toggle position-relative mt-2" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="mvc/Assets/images/bell.png">
                                    <?php $count = 0;
                                    $lc = 0;
                                ...
                                <div id="popupshow" class="dropdown-menu position-absolute top-100 right-0" aria-labelledby="navbarDropdown" style='right:0;left:-100px'>
                                    <div id="list">
                                        <div class='d-flex align-items-center' style="display: flex;justify-content:space-between;color:gray;">
                                            <div id="settinglink" style="color: black;"><i class="fa fa-cog pl-2 pr-0 pb-2 pt-1" aria-hidden="true" style="font-size:25px;color:gray"></i></div>
                                            Notification
                                    ...
                                    <div id="setting" style="display:none">
                                        <div class="p-2">
                                            <div class="modal-header pb-0" style="border-bottom:0 ;">
                                                ...
                                                <img class="text-end mt-2 mb-2" src="mvc/Assets/images/cancel1.png" id="closelink">
                                            </div>

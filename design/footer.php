    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-2">
            ...
            <div class="modal-body pb-0">
                <p class="mb-1">Name*</p>
                <input type="text" class="popup" name="" value="Smith Doth" disabled>
                <p class="mb-1 mt-3">Email Address*</p>
                <input type="email" class="popup" name="" value="Smith doh1234@gmail.com" disabled>
                <p class="mb-1 mt-3">Subject*</p>
                <input type="text" class="popup" name="" placeholder="Enter your subject">
                <p class="mb-1 mt-3">Message*</p>
                <textarea class="popup1" rows="4" placeholder="Enter your message" name=""></textarea>
            </div>
            <div class="modal-footer" style="border-top:0 ;">
                <button type="button" class="col-example8" data-bs-dismiss="modal">Cancle
                </button>
                <button type="button" class="col-example7" data-bs-dismiss="modal">Save
                </button>
            </div>
        </div>
    </div>

...
if ($_GET['key'] && $_GET['t']) {
  ...
  if (mysqli_num_rows($select) == 1) {
    $select = mysqli_query($connection, "select created_at from password_reset where token='$token'");
              ...
              <div class="Layer-52">
                ...
                <script>
                  function validateForm() {
                    ...
                    if (x != y) {
                      document.getElementById("error").innerHTML = "*Password need to be same*";
                      return false;
                    }
                  }
                </script>
                <form name="myForm" action="test.php" method="post"  onsubmit="return validateForm()">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" placeholder="Enter your new password..." name="password1" class="Rounded-Rectangle-2 form-control" style="font-size:14px; height:40px;">
                  </div>
                  <div class="form-group">
                  ...
                  <button class="login" name="change" type="submit">Change Password</button>
                </form>
                <p class="text-center">
